...
list3 = Listing.create!(name: "Elon's flying ego", launch_site: "Rocket Lab Launch Complex 1, New Zealand", rating: 9, price: 700_000, depart_date: Date.today, capacity:15, description: "Space travel is the ultimate adventure that humanity has always been fascinated with. It offers a unique opportunity to explore the unknown, witness breathtaking views of our planet from above, and expand our knowledge about the universe. Imagine experiencing zero gravity, seeing the stunning beauty of Earth from the International Space Station, or even landing on the moon or Mars! Space travel is no longer limited to just astronauts, with private companies like SpaceX and Virgin Galactic making it more accessible to the general public. It’s a chance to push the boundaries of what’s possible, to become part of history, and to inspire future generations. So why not seize the opportunity to fulfill your childhood dream and embark on a journey to the stars? Book your space travel adventure today and prepare to have your mind blown!", short_description: "Becuase running Twitter was to hard", user: elon, features: ['Gym', 'Entertainment', 'Spa', 'Quantum Hyperspace Drive', 'Zero-Gravity Spa', 'Artificial Intelligence Butler', 'Holographic Entertainment Suite', 'Space Garden', 'Personalized Atmosphere Control', 'Anti-Gravity Gym', 'Quantum-Entangled Teleportation', 'Infrared Sauna', 'Gravity Defying Infinity Pool', 'Bananas'])
